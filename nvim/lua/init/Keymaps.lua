...
k('n', '<C-k>', '<Cmd>Ddu<CR>')
--k('n', '<Tab>', '<Cmd>call pum#map#insert_relative(+1)<CR>')
--k('n', '<S-Tab>', '<Cmd>call pum#map#insert_relative(-1)<CR>')
--k('n', '<C-n>', '<Cmd>call pum#map#insert_relative(+1)<CR>')
--k('n', '<C-p>', '<Cmd>call pum#map#insert_relative(-1)<CR>')
--k('n', '<C-y>', '<Cmd>call pum#map#confirm()<CR>')
--k('n', '<C-e>', '<Cmd>call pum#map#cancel()<CR>')
